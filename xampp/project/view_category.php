...
<head> 
  ...
  <title>View All Computer Category</title>
...
<body style="background-color: #dee2e6">
    ...
    <div class="container-fluid">
        <br><br>
        <h3 class="text-center"><b>LIST OF COMPUTER CATEGORY</b></h3><br>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="width:250px"><a class="thinBtn adminBtn" href="detail_category.php?Brand=<?php echo $laptop['Brand']; ?>"> View Details </a></td>
                                </tr>
                            <?php 
                                endforeach;
                            ?>
