        ...
        <div class="mb-3 col-auto">
            ...
            <div hidden class="" id="newPassword">
              <div class="row">
                ...
                <div class="col-sm-9">
                  <input type="password" class="form-control" name="updatePassword" id="updatePassword" value="" onchange="fillNewPassword()" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="box" placeholder="Please enter the current password if you don't want to change it." required>
