    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 col-md-10 mx-auto">
        <div class="login-form">
          <form action="" method="POST" enctype="multipart/form-data" class="mt-7 border p-4 shadow needs-validation" style="background-color: #f6f4f1;" novalidate >
            ...
            <div class="mb-3 col-auto">
              ...
              <input type="text" class="form-control" id="custName" name="custName" pattern="[A-Za-z]+" required />
            ...
            <div class="mb-3 col-auto">
              <label for="custPassword" class="form-label" ><i class="material-icons">lock</i> Password <span class="text-danger">*</span></label >
              <input type="password" class="form-control" id="custPassword" name="custPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required />
            ...
            <div class="text-center">
              <div class="row justify-content-center">
                ...
                <button type="button" name="back" class="smallBtn custBtn" onclick="location.href='welcome.php';" value="back" id="back" >Back </button>
                &nbsp; &nbsp; &nbsp;
                <button type="submit" name="login" class="smallBtn impBtn" value="Login" id="login" onclick="clearcheckbox()" >Login </button>
