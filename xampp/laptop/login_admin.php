<?php
    ...
    if (isset($_POST['login'])) {
      ...
      $sqllogin = "SELECT * FROM 'admin' WHERE adminName = '$adminName' AND adminPassword='$adminPassword'";
      $result = mysqli_query($connection, $sqllogin);
      $number_of_rows = mysqli_num_rows($result);
      
      if ($number_of_rows != 0) {
          
        $select = mysqli_query($connection, "SELECT adminID FROM 'admin' where adminName = '$adminName' AND adminPassword='$adminPassword'");
